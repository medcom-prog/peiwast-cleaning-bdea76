...
// Accessible colors on #0F1B2D dark bg:
// White: #FFFFFF — 15.7:1 ✓
// #C8D0DC — 9.5:1 ✓ (secondary text)
// #D4F063 — 10.2:1 ✓ (accent)
// #96A3B5 — 5.3:1 ✓ (borderline — use for disabled/decorative only)
...
export function PriceCalculator() {
  ...
  const labelStyle: React.CSSProperties = {
    ...
    color: '#C8D0DC',  // was #96A3B5 — now passes WCAG AA on dark bg
  };

  const dimStyle: React.CSSProperties = {
    fontSize: '0.6875rem',
    color: '#96A3B5',  // ok for decorative / non-essential info
  };
      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            <p className="font-sans leading-relaxed mb-8" style={{ color: '#C8D0DC' }}>
            ...
            <p className="font-mono uppercase" style={dimStyle}>
          ...
          >
            <div>
              <p className="font-mono uppercase mb-3" style={labelStyle}>Type renhold</p>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <label htmlFor="sqm-slider" className="font-mono uppercase" style={labelStyle}>
                  Areal
                </label>
                <span className="font-display font-bold text-2xl" style={{ color: '#D4F063' }}>
                  {sqm} m²
                </span>
              </div>
              <input
              ...
              />
              <div className="flex justify-between font-mono mt-1" style={dimStyle}>
                <span>50 m²</span>
                <span>2 000 m²</span>
              </div>
            </div>
            ...
            <div>
              <p className="font-mono uppercase mb-3" style={labelStyle}>Frekvens</p>
                ...
                {(Object.keys(freqLabels) as Frequency[]).map(f => (
                  <button
                    ...
                    style={
                      frequency === f
                        ? { backgroundColor: '#D4F063', color: '#0F1B2D', borderColor: '#D4F063' }
                        : { color: '#E8EBF0', borderColor: 'rgba(255,255,255,0.2)' }
                    }
                  >
                    {freqLabels[f]}
                  </button>
            ...
            >
              <p className="font-mono uppercase" style={labelStyle}>
              ...
              <p className="font-sans text-sm" style={{ color: '#C8D0DC' }}>
